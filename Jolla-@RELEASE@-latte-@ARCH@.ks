# DisplayName: Jolla latte/@ARCH@ (release) 1
...
repo --name=adaptation-community-latte-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/xiaomi:/latte/sailfish_latest_@ARCH@/
repo --name=adaptation-community-common-latte-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
repo --name=adaptation-community-native-common-latte-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/native-common/sailfish_latest_@ARCH@/
...
%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/latte
...
### end 50_os-release
### begin rotation_hack
sed -e "s/return allowed/return Orientation.All/" -i  $INSTALL_ROOT/usr/lib/qt5/qml/Sailfish/Silica/Page.qml
### end rotation_hack
%end

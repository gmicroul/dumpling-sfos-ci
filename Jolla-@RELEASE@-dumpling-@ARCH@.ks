# DisplayName: Jolla dumpling/@ARCH@ (release) 1.5.4
# KickstartType: release
# DeviceModel: dumpling
# DeviceVariant: dumpling
# Brand: Jolla
...
%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/dumpling

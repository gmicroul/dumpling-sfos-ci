# DisplayName: Jolla davinci/@ARCH@ (release) 0.2.11
# KickstartType: release
# DeviceModel: davinci
# DeviceVariant: davinci
# Brand: Jolla
...
repo --name=adaptation-community-davinci-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/testing:/hw:/xiaomi:/davinci/sailfishos_@RELEASE@/
repo --name=adaptation-community-common-davinci-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/testing:/hw:/common/sailfishos_@RELEASE@/
...
%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/davinci
